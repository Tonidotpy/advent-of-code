...
you need to check all <span style="color: #ffff66; text-shadow: 0 0 5px #ffff66;">fifty stars</span> by December 25th.

Collect stars by solving puzzles.
Two puzzles will be made available on each day in the Advent calendar; the second puzzle is unlocked when you complete the first.
Each puzzle grants <span style="color: #ffff66; text-shadow: 0 0 5px #ffff66;">one star</span>. Good luck!
